...
%     initial weight array
    ...
    winningNeuronPositionInit = WinningNeuronPos(distanceInit) + normrnd(0,0.02,[1,2]);


    if label == 0
        subplot(1,2,1)
        scatter(winningNeuronPositionFinal(1),winningNeuronPositionFinal(2),'green','filled')
        hold on
    ...
    if label == 1
        scatter(winningNeuronPositionFinal(1),winningNeuronPositionFinal(2),'red','filled')
    ...
    if label == 2
        scatter(winningNeuronPositionFinal(1),winningNeuronPositionFinal(2),'blue','filled')
